package com.github.matech.imagepicker.provider
...
import com.github.matech.imagepicker.ImagePickerActivity
import com.github.matech.imagepicker.util.ExifDataCopier
import com.github.matech.imagepicker.util.FileUtil
import com.github.matech.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.github.matech.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
